...
const dropdownData = [
    ...
    { title: "Location", icon: IconMapPin, options: ['Islamabad', 'Karachi', 'Rawalpindi', 'Multan', 'Berlin', 'Tokyo', 'Sydney', 'Toronto'] },
...
const jobList = [
    ...
    },
    {
        ...
        package: "38 Lac",
        postedDaysAgo: 8,
        description: "Google is hiring a Backend Developer to join our team in Lahore. You'll be responsible for developing scalable backend systems that power our services. This role requires strong problem-solving skills and experience with modern backend technologies."
    },
    {
        ...
        package: "34 Lac",
        postedDaysAgo: 8,
        description: "Spotify is looking for an SMM Manager to lead our social media marketing efforts in Karachi. You will create and manage campaigns to promote our music streaming service, engage with our audience, and drive growth. This role is ideal for creative marketers with a passion for music."
    },
    {
